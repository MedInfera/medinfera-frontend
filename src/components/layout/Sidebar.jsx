...
// ─── Nav Item ─────────────────────────────────────────────────────────────────
function NavItem({ to, icon, label, collapsed, end: isEnd, onNavigate }) {
  return (
    <NavLink
      to={to}
      end={isEnd}
...
// ─── Sidebar ─────────────────────────────────────────────────────────────────
export default function Sidebar({ navGroups, mobileOpen, onMobileClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          flex flex-col bg-white border-r border-slate-100 h-screen sticky top-0 transition-all duration-200 z-30
          fixed md:relative
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pr-2 flex-shrink-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={onMobileClose}
              className="md:hidden w-7 h-7 rounded-lg flex items-center justify-center text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors"
            ...
            <button
              ...
              className="hidden md:flex w-7 h-7 rounded-lg items-center justify-center text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors flex-shrink-0"
